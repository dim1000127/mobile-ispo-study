...
public class Adapter extends BaseAdapter {
    ...
    public Adapter (Context context2, List<Note> note){
        context = context2;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvText4 = (TextView) layout.findViewById(R.id.tvTextPriority);
        tvText4.setText(notes.get(position).getPriority().toString());
        return convertView;
    }
}
